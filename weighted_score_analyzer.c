...
// Function to read a set of scores from the user
...
// Function to print calculated scores
...
// Function to print score distribution by ranges (0-9, 10-19, ..., 90-99)
...
// Function to print frequency of each score (0-100)
